...
public class AuctionControllerTests
{
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepo.GetAuctionByIdAsync(default).ReturnsForAnyArgs(auction);
    ...
    {
        // arrange
        _auctionRepo.GetAuctionByIdAsync(default)
    ...
    public async Task CreateAuction_WithValidCreateAuctionDto_ReturnsCreatedAtAction()
    {
        ...
        _auctionRepo.SaveChangesAsync().ReturnsForAnyArgs(true);
    ...
    public async Task CreateAuction_FailedSave_Returns400BadRequest()
    {
        // arrange
        var auction = _fixture.Create<CreateAuctionDto>();
        _auctionRepo.SaveChangesAsync().ReturnsForAnyArgs(false);
        ...
        Assert.Equal("Could not save changes to the Db", (result.Result as BadRequestObjectResult).Value);
    }
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        // arrange
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        _auctionRepo.GetAuctionEntityById(default).ReturnsNullForAnyArgs();

        // act
        var result = await _controller
            .UpdateAuction(Guid.NewGuid(), new UpdateAuctionDto());
